...
description: An architectural pattern that organizes code into separate modules with clear boundaries within a single deployable unit, balancing the simplicity of a monolith with the logical separation of microservices.
created: 2026-06-17
tags:
  - architecture
  - design-patterns
